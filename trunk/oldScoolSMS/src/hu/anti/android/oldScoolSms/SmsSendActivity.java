...
import hu.anti.android.oldScoolSms.receiver.DeliveredStatusReceiver;
import hu.anti.android.oldScoolSms.receiver.SentStatusReceiver;
...
public class SmsSendActivity extends AbstractSmsActivity {
	...
	Log.d("OldScoolSMS", "Received " + action + " with content: " + intent.getData());
	...
	try {
	    ...
	    Log.d("OldScoolSMS", "doSend SMS uri: " + uri + " getScheme: [" + uri.getScheme() + "]");
